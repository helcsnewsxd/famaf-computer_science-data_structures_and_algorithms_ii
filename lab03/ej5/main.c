...
int main(int argc, char *argv[]) {
    ...
    destroy(atp, length); // ESTA LINEA ESTA PARA QUE NO SE SIGA OCUPANDO MEMORIA QUE NO SE UTILIZA, POR ELLO SE
                         // ELIMINA EL CONTENIDO REFERIDO POR EL PUNTERO Y LUEGO SE LO "DESAPUNTA"
    return (EXIT_SUCCESS);
}
